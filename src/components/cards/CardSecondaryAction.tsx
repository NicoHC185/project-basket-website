...
const CardSecondaryAction = ({ title, link, icon }: { title: string, link: string, icon: ReactElement }) => {
          ...
          <Avatar href={link} target="_blank" alt="MUI Logo" size="badge" color="primary" outline>
            <svg width="500" height="500" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0)">
                ...
                />
                <path d="M212.5 282.55V325.85L287.5 369.15V325.85L212.5 282.55Z" fill={theme.palette.primary.color800} />
                <path
